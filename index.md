...
<p>
As large language models (e.g. GPT-3, [GPT-4](http://arxiv.org/abs/2303.08774), [Llama 3](https://llama.meta.com/llama3/), PALM, and Pangu-$\Sigma$), pre-trained speech models (e.g. wav2vec, Hubert, wavLM, Whisper,  [Conformer-1](https://www.assemblyai.com/blog/conformer-1/) and [Conformer-2](https://www.assemblyai.com/blog/conformer-2/)) and other foundation models (e.g. [GPT-4o](https://openai.com/index/hello-gpt-4o/), and [Stable Diffusion](https://stability.ai/stable-image)) have advanced rapidly and become more prominent and widespread, improving their efficiency would be more crucial. 
